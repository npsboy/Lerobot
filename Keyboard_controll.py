...
back_arm_length = 10
base_height = 5
obj_coordinates = {"x": 10, "y": 15, "z": 30}
arm_base_to_obj = math.hypot(obj_coordinates["z"], obj_coordinates["y"])
base_angle_1 = math.atan(obj_coordinates["z"] / obj_coordinates["y"])
arm_base_to_wrist_base = math.hypot(arm_base_to_obj, wrist_length)
base_angle_2 = math.atan(wrist_length / arm_base_to_obj)
base_angle_3 = 90 - (base_angle_1 + base_angle_2)
back_arm_base_to_wrist_base = third_side(base_height, arm_base_to_wrist_base, base_angle_3)
